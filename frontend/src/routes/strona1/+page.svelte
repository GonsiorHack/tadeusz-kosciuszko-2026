<script>
  ...
  const messages = [
    "Witaj, pionku!",
    "Nie podoba mi się to, ale muszę przyznać...",
    "...potrzebuję twojej pomocy!",
    "Wroga królowa uzurpuje sobie prawa do tronu tego królestwa, a ja kompletnie nie znam się na tym całym cyberbezpieczeństwie.",
    "Potrzebuję kogoś, kto pomoże mi odzyskać mój tron i pokonać tę bezwzględną królową. Czy jesteś gotowy, by wyruszyć ze mną w tę niebezpieczną podróż?"
  ];
  
  // Check if there's a saved message index from navigation
  ...
  onMount(() => {
    ...
    if (savedIndex) {
      ...
      // Clear the index for strona2 when starting fresh
