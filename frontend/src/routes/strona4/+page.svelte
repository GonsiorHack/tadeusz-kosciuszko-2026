<script>
      ...
      if (charIndex < fullText.length) {
        ...
        autoProgressTimeout = setTimeout(() => {
          if (currentMessageIndex < messages.length - 1) {
            ...
            sessionStorage.setItem('strona4_index', currentMessageIndex.toString());
            sessionStorage.setItem('strona3_index', (messages.length - 1).toString());
  ...
  onMount(() => {
    const savedIndex = sessionStorage.getItem('strona4_index');
    if (savedIndex) {
...
<main>
    <nav class="glass-nav">
        <div class="nav-container">
            <button class="back-button" onclick={() => (location.href = '/strona3')}>
            ...
            <div class="page-counter">4 / 10</div>
        </div>
    </nav>
