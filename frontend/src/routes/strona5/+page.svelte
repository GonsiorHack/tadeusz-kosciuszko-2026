<script>
      ...
      if (charIndex < fullText.length) {
        ...
        autoProgressTimeout = setTimeout(() => {
          if (currentMessageIndex < messages.length - 1) {
            currentMessageIndex++;
            sessionStorage.setItem('strona5_index', currentMessageIndex.toString());
            typeMessage();
          } else {
            sessionStorage.setItem('strona5_index', currentMessageIndex.toString());
            sessionStorage.setItem('strona4_index', (messages.length - 1).toString());
  ...
  onMount(() => {
    const savedIndex = sessionStorage.getItem('strona5_index');
    if (savedIndex) {
...
<main>
    <nav class="glass-nav">
        <div class="nav-container">
            <button class="back-button" onclick={() => (location.href = '/strona4')}>
            ...
            <div class="page-counter">5 / 10</div>
        </div>
    </nav>
