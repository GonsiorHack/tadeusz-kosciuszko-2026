<script>
      ...
      if (charIndex < fullText.length) {
        ...
        autoProgressTimeout = setTimeout(() => {
          if (currentMessageIndex < messages.length - 1) {
            ...
            sessionStorage.setItem('strona6_index', currentMessageIndex.toString());
            sessionStorage.setItem('strona5_index', (messages.length - 1).toString());
  ...
  onMount(() => {
    ...
    if (savedIndex) currentMessageIndex = parseInt(savedIndex);
    typeMessage();
